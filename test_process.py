...
# Se asume que el código del parser (con la función process_html) se encuentra en Parser/process.py
...
def test_process_html_csv_generation():
    ...
    expected_header = ["FechaDescarga", "Barrio", "Valor", "NumHabitaciones", "NumBanos", "mts2"]
    ...
    # Segundo listing: se espera "N/A" pues no hay segunda parte en la ubicación
...
def test_process_html_filename():
    ...
    # Se asume que fake_put_object ha capturado el CSV, por lo que comprobamos que existe csv_content
